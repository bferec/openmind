...
$(APPNAME): $(APPNAME).c $(APPNAME)lib.o $(APPNAME)varlist.o syntaxtree.o arithmeticOperator.o logicalOperator.o  $(APPNAME)interpret.o lex.yy.o $(APPNAME).tab.o
	$(CC) $(LDFLAGS) -o fdl.c $(APPNAME)lib.o $(APPNAME)varlist.o syntaxtree.o arithmeticOperator.o logicalOperator.o  $(APPNAME)interpret.o lex.yy.o $(APPNAME).tab.o
